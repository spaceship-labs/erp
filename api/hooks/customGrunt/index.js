 ...
 */
/*
hook grunt disable default
copy node_modules/sails/lib/hooks/grunt/index.js;
grunt async: prod,dev.
*/
module.exports = function (sails) {
  ...
  return {
    ...
    initialize: function (cb) {
      ...
      sails.config.environment =  process.env.NODE_ENV  || 'development';
    ...
    runTask: function (taskName, cb_afterTaskStarted) {
      ...
      var pathToSails = path.resolve(__dirname, '../../../node_modules/sails/');
